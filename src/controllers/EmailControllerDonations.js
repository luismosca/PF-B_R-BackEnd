...
const EmailControllerDonations = (userEmail) => {
        ...
        <div style="width: 100%; background-color: #e3e3e3;">
            <div style="padding: 20px 10px 20px 10px;">
                ...
                <div style="background-color: #c5f663; padding: 10px 0px 10px 0px; width: 100%; text-align: center;">
                    <img src= "https://res.cloudinary.com/drhqzywsx/image/upload/v1695850108/proyecto_pf/B_R_slxacx.png" alt="logo" style="width: 200px; height: 200px;">
                </div>
                <!-- Imagen inicial -->
    
                <!-- Contenido principal -->
                <div style="background-color: #ffffff; padding: 20px 0px 5px 0px; width: 100%; text-align: center;">
                    <h1>Gracias por tu Donacion en ByR</h1>
                    <p>Gracias por tu aporte al proyecto, Nos ayudas seguir creciendo y mejorando dia a dia!</p>
...
module.exports = { EmailControllerDonations };
